from vpython import cylinder, arrow, scene, vector, color, label
...
r = arrow(pos=vector(0, 0, 0), axis=vector(6, 23, 2000), color=color.purple, shaftwidth=9)
rlbl = label(pos=vector(6, 23, 2000), text="r=6x+23y+2000z", color=color.black, opacity=0, height=30, box=0)
# my birthday is 06/23/2000 so I have a very long vector. I was 9 lbs when I was born so thats why the vector is
# rather girthy
